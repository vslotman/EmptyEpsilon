...
GuiSliderWithoutMouse::GuiSliderWithoutMouse(GuiContainer* owner, string id, float min_value, float max_value, float start_value, func_t func)
: GuiSlider(owner, id, min_value, max_value, start_value, func)
{
}
