...
public:
    ...
    float getShieldFrequency() { return shield_frequency; }
    void setShieldFrequency(float freq) { if ((freq > SpaceShip::max_frequency) || (freq < 0)) return; shield_frequency = freq;}
